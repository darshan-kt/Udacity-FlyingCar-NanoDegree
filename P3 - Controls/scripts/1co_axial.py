...
In this exercise, you will populate the CoaxialCopter class with three methods. These functions will calculate vertical acceleration 𝑧¨
, angular acceleration 𝜓¨ along the 𝑧 axis and the angular velocities 𝜔1 and 𝜔2 of the propellers required to achieve any desired 𝑧¨ and 𝜓¨.

We assume that drone only can travel and rotate along the vertical 𝑧axis.

Remember, the positive 𝑧axis points downwards.
...
# TEST CODE 1
bi = CoaxialCopter()
stable_omega_1,stable_omega_2 = bi.set_rotors_angular_velocities(2.0, 5.0)
