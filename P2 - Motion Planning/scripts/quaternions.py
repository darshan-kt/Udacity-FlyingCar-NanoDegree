...
Additionally, some messages represent gyro related data as a quaternion, while others use euler angles. It's beneficial to seamlessly handle both. Given a representation udacidrone performs a conversion and stores both representations.
'''
