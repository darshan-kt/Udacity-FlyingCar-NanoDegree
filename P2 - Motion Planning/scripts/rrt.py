...
#Nearest Neighbors
#A critical part of the RRT procedure is finding the closest vertex to the sampled random point. This the most computationally intensive part so be mindful of that. 
# Depending on the number of vertices a naive implementation will run into trouble quickly.
...
num_vertices = 300  #If increase this value graph can reach throughot map
dt = 1
x_init = (50, 50)
